 ...
 */
@property(nonatomic, weak, readwrite) UIButton *volumeUpButton;
 ...
 * current session does not support volume adjustment.
 */
@property(nonatomic, weak, readwrite) UIButton *volumeDownButton;
 ...
 */
@property(nonatomic, weak, readwrite) UISlider *volumeSlider;
 ...
 */
@property(nonatomic, weak, readwrite) UISwitch *muteSwitch;
 ...
 */
@property(nonatomic, weak, readwrite) GCKUIButton *muteToggleButton;
