 ...
 */
- (NSInteger)setActiveTrackIDs:(NSArray<NSNumber *> *)activeTrackIDs;
 ...
 * sent or if any of the parameters are invalid.
 */
- (NSInteger)queueUpdateItems:(NSArray<GCKMediaQueueItem *> *)queueItems customData:(id)customData;
 ...
 * sent or if any of the parameters are invalid.
 */
- (NSInteger)queueRemoveItemsWithIDs:(NSArray<NSNumber *> *)itemIDs customData:(id)customData;
 ...
 * sent.
 */
- (NSInteger)queueJumpToItemWithID:(NSUInteger)itemID customData:(id)customData;
