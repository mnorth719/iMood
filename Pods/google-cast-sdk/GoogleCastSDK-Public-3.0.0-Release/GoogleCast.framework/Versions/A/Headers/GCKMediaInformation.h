 ...
 */
@property(nonatomic, copy, readonly) NSArray<GCKMediaTrack *> *mediaTracks;
...
- (instancetype)initWithContentID:(NSString *)contentID
                   ...
                   streamDuration:(NSTimeInterval)streamDuration
                      mediaTracks:(NSArray<GCKMediaTrack *> *)mediaTracks
 ...
 * with the given ID.
 */
- (GCKMediaTrack *)mediaTrackWithID:(NSInteger)trackID;
