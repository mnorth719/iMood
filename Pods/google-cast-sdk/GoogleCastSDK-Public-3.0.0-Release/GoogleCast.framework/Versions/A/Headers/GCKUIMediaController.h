 ...
 * @since 3.0
 */
GCK_EXTERN const UIControlState GCKUIControlStateRepeatOff;
 ...
 * @since 3.0
 */
GCK_EXTERN const UIControlState GCKUIControlStateRepeatAll;
 ...
 * @since 3.0
 */
GCK_EXTERN const UIControlState GCKUIControlStateRepeatSingle;
 ...
 * @since 3.0
 */
GCK_EXTERN const UIControlState GCKUIControlStatePlay;
 ...
 * @since 3.0
 */
GCK_EXTERN const UIControlState GCKUIControlStatePause;
 ...
 * @since 3.0
 */
GCK_EXTERN const UIControlState GCKUIControlStateShuffle;
 ...
 * @since 3.0
 */
typedef NSString * (^GCKUIValueFormatter)(const id value);
 ...
 */
@property(nonatomic, weak, readwrite) id<GCKUIMediaControllerDelegate> delegate;

/**
 * The Cast session that is associated with this controller.
 */
@property(nonatomic, strong, readonly) GCKCastSession *session;
 ...
 */
@property(nonatomic, weak, readwrite) UIButton *playButton;
 ...
 */
@property(nonatomic, weak, readwrite) UIButton *pauseButton;
 ...
 * active.
 */
@property(nonatomic, weak, readwrite) GCKUIButton *playPauseToggleButton;
 ...
 */
@property(nonatomic, weak, readwrite) UIButton *stopButton;

/**
 * A button for pausing queue playback once the current item finishes playing.
 */
@property(nonatomic, weak, readwrite) UIButton *pauseQueueButton;
 ...
 */
@property(nonatomic, weak, readwrite) UIButton *nextButton;
 ...
 */
@property(nonatomic, weak, readwrite) UIButton *previousButton;
 ...
 */
@property(nonatomic, weak, readwrite) GCKUIButton *repeatModeButton;
 ...
 * no Cast session currently active.
 */
@property(nonatomic, weak, readwrite) UISlider *streamPositionSlider;
 ...
 * currently loaded, or if there is no Cast session currently active.
 */
@property(nonatomic, weak, readwrite) UIProgressView *streamProgressView;
 ...
 * form of "--:--".
 */
@property(nonatomic, weak, readwrite) UILabel *streamPositionLabel;
 ...
 * localized form of "--:--".
 */
@property(nonatomic, weak, readwrite) UILabel *streamDurationLabel;
 ...
 */
@property(nonatomic, weak, readwrite) UILabel *streamTimeRemainingLabel;
 ...
 * currently loaded, or if there is no Cast session currently active.
 */
@property(nonatomic, weak, readwrite) UIButton *tracksButton;
 ...
 */
@property(nonatomic, strong, readonly) GCKUIImageHints *thumbnailImageHints;
 ...
 */
@property(nonatomic, weak, readwrite) UILabel *smartSubtitleLabel;

/**
 * An image view for displaying the next queued media's thumbnail image.
 */
@property(nonatomic, weak, readonly) UIImageView *nextItemThumbnailImageView;

/**
 * An image hints object to describe the image shown in nextItemThumbnailImageView.
 */
@property(nonatomic, strong, readonly) GCKUIImageHints *nextItemThumbnailImageHints;

/**
 * A label view for displaying the title of the next queued media.
 */
@property(nonatomic, weak, readwrite) UILabel *nextItemTitleLabel;

/**
 * A label view for displaying the subtitle of the next queued media.
 */
@property(nonatomic, weak, readwrite) UILabel *nextItemSmartSubtitleLabel;

/**
 * A activity indicator view for indicating media is in loading state.
 */
@property(nonatomic, weak, readwrite) UIActivityIndicatorView *mediaLoadingIndicator;
