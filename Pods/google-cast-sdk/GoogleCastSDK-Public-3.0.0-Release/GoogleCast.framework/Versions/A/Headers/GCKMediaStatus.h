 ...
 */
@property(nonatomic, assign, readonly) GCKMediaQueueItem *currentQueueItem;
 ...
 */
@property(nonatomic, assign, readonly) GCKMediaQueueItem *nextQueueItem;
 ...
 */
@property(nonatomic, readonly) NSArray<NSNumber *> *activeTrackIDs;
