 ...
 */
@property(nonatomic, weak, readwrite) id<GCKGameManagerChannelDelegate> delegate;

/**
 * The current state of the game manager.
 */
@property(nonatomic, readonly) GCKGameManagerState *currentState;
 ...
 */
@property(nonatomic, readonly) NSString *lastUsedPlayerID;
 ...
 * @return The request ID, or @ref kGCKInvalidRequestID if the request could not be sent.
 */
- (NSInteger)sendPlayerAvailableRequest:(id)extraData playerID:(NSString *)playerID;
 ...
 * @return The request ID, or @ref kGCKInvalidRequestID if the request could not be sent.
 */
- (NSInteger)sendPlayerReadyRequest:(id)extraData playerID:(NSString *)playerID;
 ...
 * @return The request ID, or @ref kGCKInvalidRequestID if the request could not be sent.
 */
- (NSInteger)sendPlayerPlayingRequest:(id)extraData playerID:(NSString *)playerID;
 ...
 * @return The request ID, or @ref kGCKInvalidRequestID if the request could not be sent.
 */
- (NSInteger)sendPlayerIdleRequest:(id)extraData playerID:(NSString *)playerID;
 ...
 * @return The request ID, or @ref kGCKInvalidRequestID if the request could not be sent.
 */
- (NSInteger)sendPlayerQuitRequest:(id)extraData playerID:(NSString *)playerID;
 ...
 * @return The request ID, or @ref kGCKInvalidRequestID if the request could not be sent.
 */
- (NSInteger)sendGameRequest:(id)extraData playerID:(NSString *)playerID;
 ...
 * @param playerID The ID of the controllable player sending this message.
 */
- (void)sendGameMessage:(id)extraData playerID:(NSString *)playerID;
